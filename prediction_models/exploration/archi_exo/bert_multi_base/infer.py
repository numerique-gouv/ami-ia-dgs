...
from text_model_boris.utils.misc import target_columns, input_columns
...
original_args = argparse.Namespace(
    ...
    max_short_text_length=getattr(config, "max_short_text_length", 26),
    max_long_text1_length=getattr(config, "max_long_text1_length", 260),
    max_long_text2_length=getattr(config, "max_long_text2_length", 210),
...
if original_args.model_type == "bert":
    ...
    tokenizer = CamembertTokenizer.from_pretrained(original_args.bert_model)
