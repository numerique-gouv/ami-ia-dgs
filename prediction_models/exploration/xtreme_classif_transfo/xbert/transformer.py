...
from xbert.modeling import BertForXMLC, RobertaForXMLC, XLNetForXMLC, CamembertForXMLC
...
MODEL_CLASSES = {
    ...
    "camembert": (CamembertConfig, CamembertForXMLC, CamembertTokenizer),
}
...
class TransformerMatcher(object):
    ...
    def predict(self, args, X_eval, C_eval_true, topk=1, get_hidden=False):
        ...
        for batch in tqdm(eval_dataloader):
            ...
            cpred_topk_vals, cpred_topk_cols = c_pred.topk(c_pred.shape[1], dim=1)
